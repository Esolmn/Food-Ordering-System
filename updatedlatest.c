...
void get_order(char menu[10][100]){
    ...
    sprintf(deliver,"C:/Users/User/Desktop/Delivery/Order_%s.txt",info.buyername);
    sprintf(reserved,"C:/Users/User/Desktop/Reserved/Order_%s.txt",info.buyername);	
...
/*	switch(receive){
    ...
    FILE *view; 
    view= fopen ("C:/Users/User/Desktop/orders/ORDER.txt", "a");
    fprintf(view, "Name: %s\n", info.buyername);
    ...
    FILE *sales = fopen("C:/Users/User/Desktop/Sales/sales.txt", "a"); 
...
void view_order(){
    ...
    char string [1000];
 	FILE *view; 
    view= fopen ("C:/Users/User/Desktop/orders/ORDER.txt", "r");
...
int regis()
{
	...
	FILE *sellerinfo = fopen("C:/Users/User/Desktop/Pass/seller.txt", "w");
...
int total_sales(){
    FILE *total_sales = fopen("C:/Users/User/Desktop/Sales/sales.txt", "r");
    if (total_sales == NULL) {
