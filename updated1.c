...
void buyer (){
	...
	sprintf(filename, "C:Final Project/Files/Orders/orders.txt", info.buyername);
...
void get_order(char menu[10][100]){
	int price = 60, delivery = 10, meal, qty, again, receive, i = 0, n;
	float amount, total_amount;
	char order[100], address[100];
	char Orders[10][100], Numbers[10], Total[10];
	line();
	...
	sprintf(filename, "C:Final Project/Files/Orders/orders.txt", info.buyername);
    buyerinfo = fopen(filename, "a");	
	fprintf(buyerinfo, "Order : %s\n", order);
	...
	for (int j = 0; j < i; j++){
		...
		printf("\n");
		total_amount = Total[j] + total_amount;
	}
	printf("\nTotal: %.2f\n",total_amount);
	
    FILE *sales = fopen("C:Final Project/Files/Sales/sales.txt", "a"); 
...
void view_order(){
    char string [100];
 	...
 	FILE *seller;
    seller = fopen ("C:Final Project/Files/Orders/orders.txt", "r");
...
void login()
{
    ...
    FILE *seller = fopen("C:Final Project/Files/Users/seller.txt", "r");
...
int regis()
{
	...
	FILE *sellerinfo = fopen("C:Final Project/Files/Users/seller.txt", "w");
...
int total_sales(){
    ...
    FILE *total_sales = fopen("C:Final Project/Files/Sales/sales.txt", "r");
    if (total_sales == NULL) {
